...
if ( !class_exists( 'AspexiLoginAudit' ) ) {
    ...
    define('ASPEXILOGINAUDIT_VERSION', '1.0.1');
    ...
    class AspexiLoginAudit
    {
        ...
        private $emails_per_hour = 20;
        private $emails_sent_last_hour_transient = 'ala_emails_sent_last_hour';
                                    ...
                                    <div class="inside">
                                        <table class="form-table">
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    <input disabled readonly type="checkbox" name="ala_email_info_type_success" value="on" <?php echo ( $this->config['email_info_type_success'] == 'on' ) ? 'checked' : '' ; ?> ><?php _e('Login Successful','aspexiloginaudit'); ?><br />
                                                    <input disabled readonly type="checkbox" name="ala_email_info_type_error" value="on" <?php echo ( $this->config['email_info_type_error'] == 'on' ) ? 'checked' : '' ; ?> ><?php _e('Login Failed','aspexiloginaudit'); ?><br />
                                                    <input disabled readonly type="checkbox" name="ala_email_info_type_bruteforce" value="on" <?php echo ( $this->config['email_info_type_bruteforce'] == 'on' ) ? 'checked' : '' ; ?> ><?php _e('Login Failed (Brute Force)','aspexiloginaudit'); ?><br />
                                                    <?php echo $this->get_pro_link(); ?>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                    ...
                    if ($loginInfo != false): ?>
                        <table id="ala_logs" class="wp-list-table widefat fixed striped">
                            ...
                            <?php foreach( $loginInfo as $logs): ?>
                                <tr<?php echo ( ( '2' == $logs->status )? ' style="background-color: rgba(255,0,0,0.05);"' : ' style="background-color: rgba(0,255,0,0.05);"') ?>>
                                    <td data-colname="<?php echo __( 'Status', 'aspexiloginaudit' ); ?>"><?php if ( $logs->status == '1' ) { echo  __( 'Login Successful', 'aspexiloginaudit' ); } elseif ( $logs->status == '2' ) { echo __( 'Login Failed', 'aspexiloginaudit' ); } ?></td>
